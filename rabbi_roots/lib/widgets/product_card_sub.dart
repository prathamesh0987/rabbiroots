...
class _ProductCardState extends State<ProductCard> {
  ...
  void increment() {
    setState(() {
      quantity++;
      context.read<CartModel>().updateQuantity(widget, quantity);
    });
  }
  ...
  void decrement() {
    if (quantity > 1) {
      ...
      setState(() {
        ...
        context.read<CartModel>().removeProduct(widget);
      });
    }
  }
  ...
  void addToCart() {
    setState(() {
      ...
      context.read<CartModel>().addProduct(widget);
    });
  }
        ...
        return Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Stack(
                clipBehavior: Clip
                    .none, // To allow the button to overflow outside the image
                children: [
                  // Product Image
                  Center(
                    child: Container(
                      ...
                      decoration: BoxDecoration(
                        image: DecorationImage(
                          image: widget.imageUrl.startsWith('http')
                              ? NetworkImage(
                                  widget.imageUrl) // For network URLs
              ...
              Row(
                ...
                children: [
                  Text(
                    "₹${widget.price}", // Show price for current quantity
                    style: TextStyle(
                      fontSize: fontSize + 2,
                      fontWeight: FontWeight.bold,
                    ),
